...
### Алгоритм решения
Принять х как максимум Сравнить с у, обновить максимум Сравнить с z, обновиться максимум Вернуть результат
...
### Алгоритм решения
Найти сумму х+у Если сумма между 10 и 19 -> вернуть 20 Иначе -> вернуть сумму
...
### Алгоритм решения
Использовать switch по числу от 1 до 7 Вернуть строку с названием дня Если число не от 1 до 7 -> вернуть "Это не день недели"
...
### Алгоритм решения
Создать пустую строку В цикле от 0 до х добавить число и пробел Вернуть строку
...
### Алгоритм решения
Создать пустую строку В цикле от 0 до х идти с шагом 2 Добавлять число и пробел Вернуть строку
...
### Алгоритм решения
Взять модуль числа Если число равно 0 -> вернуть 1 Если число больше 0 -> делить на 10 и увеличить счётчик Вернуть счетчик
...
### Алгоритм решения
Внешний цикл от 0 до х -> строки Внутренний цикл от 0 до х -> печать * После строки переход на новую
...
### Алгоритм решения
Внешний цикл по строкам Внутренний цикл по столбцам Печатаем пробелы, пока не дойдем до правого края Печатаем *
...
### Алгоритм решения
Пройти по массиву Если элемент равен х, вернуть его индекс Если не нашли -> вернуть -1
...
### Алгоритм решения
Взять первый элемент как максимум Пройти по массиву ЕСли модуль текущего элемента больше модуля максимума -> заменить максимум Вывусти максимум
...
### Алгоритм решения
Создать новый массив (длинна - сумма размеров массивов) Скопирвоать все элементы до позиции Вставить второй массив Добавить оставшиеся элементы первого массива
...
### Алгоритм решения
Создать новый массив Пройти по первому массиву, копируя элементы с конца в начало ВЕрнуть новый массив
...
### Алгоритм решения
Посчитать количество вхождений х Создать массив такой длины Пройти по массиву еще раз, записывая индексы, где стоит х Вернуть массив индексов
